...
async def generate_speech_internal(
    ...
    try:
        ...
        # Convert to WAV format (write to a real path — torchaudio/TorchCodec cannot encode to BytesIO)
        ...
        fd, tmp_wav = tempfile.mkstemp(suffix=".wav", prefix="chatterbox_tts_")
        os.close(fd)
        try:
            ta.save(tmp_wav, final_audio_cpu, model.sr, format="wav")
